          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              ...
              >
                ...
                <h1 className="mb-2 text-4xl font-bold leading-tight text-white dark:text-white sm:text-5xl sm:leading-tight md:mb-5 md:text-6xl md:leading-tight lg:text-7xl">
                  Freelance{" "}
                ...
                <div className="flex flex-col-reverse md:flex-col">
                  <div className="mt-12 flex w-full flex-col items-center justify-center md:mt-0">
                    <button
                      ...
                      className="flex items-center gap-3 rounded-md border-2 border-white bg-primary px-8 py-4 text-base font-semibold text-white shadow-lg duration-300 ease-in-out hover:bg-black/30 dark:bg-black dark:text-white dark:hover:bg-white/30 sm:text-xl md:text-xl lg:text-xl xl:text-2xl"
                    >
                  ...
                  <div className="mt-12 flex w-full flex-col items-center justify-center md:mt-0">
                    <div className="-mt-16 flex flex-col items-center w-full justify-center sm:-mt-14 md:mt-1 xl:w-full">
                      ...
                      <div className="relative aspect-video bg-black w-full xl:w-[1100px]">
                        <iframe
