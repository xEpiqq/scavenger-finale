...
function Item({ item, openCRM, toggleselected, selected }) {
  ...
  return (
    <tr>
      ...
      <td className={td_styles + " max-w-[15rem] overflow-hidden"}>
        <div>
      ...
      <td className={td_styles}>
        <div className="z-0 flex w-24 flex-row items-center gap-[2px]">
          {item.facebook ? (
          ...
          {item.twitter ? (
            <Link href={item.twitter} target="_blank" className="h-5 w-5">
              <img src="/Twitter.svg" alt="facebook link" className="h-5 w-5" />
            </Link>
          ) : (
            <img
              src="/Twitter.svg"
          ...
          {item.youtube ? (
            <Link href={item.youtube} target="_blank" className="">
              <img src="/Youtube.svg" alt="facebook link" className="h-5 w-5" />
            </Link>
          ) : (
            <img
              src="/Youtube.svg"
